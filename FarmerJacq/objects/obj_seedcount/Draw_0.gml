...
if global.plants[global.plantsIndex] == "basic" {draw_sprite_ext(spr_red_seed,-1,cx + cw/2, cy + 50,1.2,1.2,30,c_white,0.7);}
else{draw_sprite_ext(spr_red_seed,-1,cx + cw/2, cy + 50,1,1,0,c_black,0.5);}
