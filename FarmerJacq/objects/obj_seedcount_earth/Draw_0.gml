...
if global.plants[global.plantsIndex] == "earth" {draw_sprite_ext(spr_bean_earth,-1,cx + cw/2+120, cy + 50,1.2,1.2,30,c_white,0.7);}
	else{draw_sprite_ext(spr_bean_earth,-1,cx + cw/2 +120, cy + 50,1,1,0,c_black,0.5);}

draw_text(cx + cw/2 + 120 + 50, cy + 40, string(global.earthSeedCount));