...
if (hp<=0){
	...
	instance_create_layer(x+5, y, "Instances", obj_seed);
	instance_create_layer(x+10, y, "Instances", obj_seed);
	instance_create_layer(x+15, y, "Instances", obj_seed);
	instance_create_layer(x+25, y, "Instances", obj_seed);
